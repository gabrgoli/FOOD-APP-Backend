...
server.use((req, res, next) => {
  res.header('Access-Control-Allow-Origin', 'https://food-app-frontend-ar1pfxfc7-gabrgoli.vercel.app'); // update to match the domain you will make the request from 
